...
def _merge_external_data(X):
        ...
        features_to_keep = ['WeeksToDeparture', 'oil_stock_volume',
                            ...
                            'SP_stock_volume', 'distance', 'UnemploymentRate_dep',
                            'UnemploymentRate_arr', 'day_departure', 'n_days_departure',
                            'Max TemperatureC_dep', 'Max TemperatureC_arr', 'route_mean',
                            'day_nb_mean', 'day_mean', 'week_mean', 'month_mean']

        X_merged = X_merged[features_to_keep]
        # X_merged.drop(['Arrival', 'Departure', 'closest_holidays_dep', 'closest_holidays_arr'], inplace=True, axis=1)
