...
def gen_state_features():
    ...
    # Unemployment Rate
    unemployment_df = pd.read_csv("../data/state_data/unemployment_rate.csv", sep=';', index_col='State')
    ...
    states_codes = pd.read_csv("../data/state_data/states.csv")
    gdp_per_cap = pd.read_csv('../data/state_data/GDP_per_capita_states.csv', sep=';')
    school_holidays = pd.read_csv('../data/state_data/holidays.csv', sep=';', parse_dates=['date'])
