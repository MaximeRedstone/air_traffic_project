...
from db.generate_db_date import gen_date
from db.generate_db_statistics import gen_statistics
from db.generate_db_airport import gen_airport
from db.generate_db_state_features import gen_state_features

from db.helpers import _encode_dates

def gen_routes():
    return pd.read_csv('../data/airport/routes_means.csv', sep=';')

def gen_passengers():
    passengers_df = pd.read_csv('../data/airport_per_date/passengers_per_flight.csv', sep=',')
